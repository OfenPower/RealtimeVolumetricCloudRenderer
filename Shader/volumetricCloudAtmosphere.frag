...
uniform sampler3D perlworl;		// 3d texture with the low frequency perlin-worley noise. Used to model the base shape of the clouds
uniform sampler3D worl;			// 3d texture with the high frequency worley noise. Used to carve out details from the clouds base shape
